...
function EditResponse() {
    ...
    const fetchData = async () => {
        try {
            // const token = localStorage.getItem('authToken'); // Token handled by service
            ...
            // Mevcut koda göre: respData.answers -> [{ question: 1, value: "A" }]
            const initialAnswers = {};
            respData.answers.forEach(ans => {
                initialAnswers[ans.question] = ans.value;
            });
